...
remotes::install_github("renozao/xbioc", upgrade = "never", ref = "1354168bd7e64be4ee1f9f74e971a61556d75003", clean = TRUE)
remotes::install_github("meichendong/SCDC", upgrade = "never", ref = "890c604eebd7fffa4a08d7344fbd516df6efcf8d", clean = TRUE)
